class gameStart {
    ...
    this.que = [
      {
        ...
        answer: "Abuja",
        options: ["Lagos", "Ogun", "Abuja", "Freetown"],
      },
      {
        num: 2,
        question: " What is the capital of Ghana? ",
        answer: " Accra",
        options: ["Cape Town ", " Bamako", "Cairo", " Accra"],
      },
      {
        num: 3,
      ...
      },
      {
        ...
        answer: "June 12",
        options: ["June 1", " July 1", " June 12", " July 12"],
      },
      {
        num: 5,
      ...
      },
      {
        num: 8,
        question:
          " What does the colour 'blue' represent in the flag of the Nigerian army? ",
      ...
      },
      {
        ...
        answer: "Atlas",
        options: ["Virunga ", " Atlas ", " None of the above ", " Mitumba "],
      },
      {
        num: 12,
      ...
      },
      {
        num: 16,
        question:
          " The capital of an African country is named after an American President. His name is ",
        answer: "James Monroe",
        options: [
          " George Washington",
          " Herbert Hoover",
      ...
      },
      {
        ...
        answer: "Algeria",
        options: [" Nigeria", " Chalk", " Morocco", " Algeria"],
      },
      {
        num: 20,
  ...
  createQuestion() {
    ...
    questionText.innerText = `${this.que[this.currentQuestion].num}.  ${
      this.que[this.currentQuestion].question
    }`;
    ...
    queOptions.forEach((element) => {
      ...
      options.addEventListener("click", () => {
        if (
          options.innerText.trim() !=
          this.que[this.currentQuestion].answer.trim()
        ) {
...
function sendEmail(e) {
  ...
  document
    ...
    .addEventListener("submit", function (event) {
      ...
      emailjs
        .send("service_2by9n4z", "template_km9pay6", tempParams)
        .then(function (res) {
